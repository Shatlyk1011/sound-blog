...
export default function Dashboard() {
  return (
    <main className='bg-background border-sidebar-border relative mt-14 ml-0 flex min-h-svh flex-col gap-20 items-center justify-start rounded-l-2xl border pt-20 pb-10'>
